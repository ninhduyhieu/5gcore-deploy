...
// 	g, err := OpenGtp5g(&wg, 2152, "0.0.0.0:2152", 1400, "upfgtp")
// 	if err != nil {
// 		t.Fatal(err)
// 	}
// 	defer g.Close()
...
// 			t.Fatal(err1)
// 		}
// 		logrus.Infof("Receive final report from URR(%d), rpts: %+v", rs[0].URRID, rs)

// 		require.NotNil(t, rs)
// 		logrus.Infof("Receive final report from URR(%d)", rs[0].URRID)
...
// 		require.NotNil(t, rs)
// 		logrus.Infof("Receive final reports from URR(%d)", rs[0].URRID)
// 	})
// }
