...
func PlmnIdToModels(value []byte) (modelsPlmnid models.PlmnId) {
...
func PlmnIdToNgap(modelsPlmnid models.PlmnId) (ngapPlmnId []byte, err error) {
	...
	if ngapPlmnId, err = hex.DecodeString(hexString); err != nil {
		err = utils.WrapError("Decode plmn failed", err)
	}
	return
}
