...
func TestRecoverSupi(t *testing.T) {
	profiles := []Profile{
		{
	...
	testcases := []struct {
		...
		{
			suci:     "suci-208-93-0000-0-0-00007487",
			expected: "imsi-2089300007487",
		},
		{
			suci: "suci-208-93-0000-1-1-b2e92f836055a255837debf850b528997ce0201cb82a" +
				"dfe4be1f587d07d8457dcb02352410cddd9e730ef3fa87",
			expected: "imsi-20893001002086",
		},
		{
			suci: "suci-208-93-0000-2-2-039aab8376597021e855679a9778ea0b67396e68c66d" +
				"f32c0f41e9acca2da9b9d146a33fc2716ac7dae96aa30a4d",
			expected: "imsi-20893001002086",
		},
	}
	for i, tc := range testcases {
		supi, err := RecoverSupi(tc.suci, profiles)
		if err != nil {
			t.Errorf("TC%d err: %+v\n", i, err)
	...
	fmt.Printf("Test supi revocery is done\n")
}
